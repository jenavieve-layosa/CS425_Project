        ...
        <div id="main-wrapper">
            ...
            <div className="page-wrapper">
                <div className="container-fluid" id="top-section">
                    ...
                    <h2 className = "subtitle text-bold text-darkblue">Introduction</h2>
                    <div className= "white-space-filler">...</div>

                    <p>Locomotion is the ability to move from one place to another. Acts like crawling, running, walking,
                    ...
                    <p>A mobile robot needs locomotion systems that allow it to freely move about its surroundings. But
                    ...
                    these systems for movement were influenced by their biological counterparts.</p></p>

                    <p>Figure: Locomotion Mechanism in Biological Systems (Source: Book)</p>

                    <h3 className = "lesson-subtitle">Key Issues with Locomotion</h3>
                    <p>Locomotion is the complement of manipulation. In manipulation, the robot arm stays in one place,
                    ...
                    of stability, contact characteristics, and environmental type:</p>
                    • Stability
