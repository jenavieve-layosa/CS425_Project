                ...
                <div className="container-fluid">
                    ...
                    <Container maxWidth="md">
                     ...
                     <h2 className="subtitle font-bold text-darkblue">Course Overview</h2>
                        ...
                        <p>
                        Perception
                            Perception is the way that people understand and make sense of the sensory information they get
                            ...
                            changes how we connect with others and how we see the world.

                            Perception in Mobile Robots
                            Mobile robots require the ability to perceive their surroundings and make decisions based on
                            ...
                            cameras, LiDAR, and ultrasonic sensors. By utilizing perception algorithms, mobile robots can
                            ...
                            Perception is vital in mobile robotics for several reasons:

                            1. Environmental Awareness: Perception allows mobile robots to gather information about
                            ...
                            2. Decision-Making: Perception provides the necessary input for mobile robots to make
                            ...
                            behaviors.
                            3. Object Detection and Recognition: Perception enables mobile robots to detect and
                            ...
                            4. Localization and Mapping: Perception helps mobile robots determine their position and
                            ...
                            information is crucial for navigation, exploration, and efficient task execution.
                            5. Safety and Collision Avoidance: Perception allows mobile robots to detect and perceive
                            ...
                            humans.
                            6. Human-Robot Interaction: Perception plays a critical role in facilitating natural and
                            ...
                            appropriately, enhancing collaboration and cooperation between robots and humans.

                            Sensor
                            A sensor is a device that detects and responds to a physical stimulus or change in the
                            ...
                            Perception and sensors are intertwined in mobile robotics. Sensors act as the primary source of
                            ...
                            interact autonomously in complex real-world environments.

                            Types of Sensors
                            There are many different types of sensors used in robotics to provide feedback to the robot about
                            its environment. Here are some examples of commonly used sensors in robotics:
                            Proximity Sensors:
                            Proximity sensors are devices that detect the presence or absence of objects without physical
                            ...
                            ● Ultrasonic Proximity Sensors: Ultrasonic sensors emit high-frequency sound waves and
                            ...
                            ● Inductive Proximity Sensors: These sensors emit an electromagnetic field and detect changes
                            ...
                            ● Capacitive Proximity Sensors: Capacitive sensors detect the presence of both metallic and
                            ...
                            contact.
                            ● Magnetic Proximity Sensors: Magnetic sensors detect changes in magnetic fields caused by
                            ...
                            ● Photoelectric Proximity Sensors: These sensors use light beams to detect the presence or
                            ...
                            interruption of the light beam by a person triggers the door to open.
                            Vision Sensors:
                            Vision sensors, also known as vision systems or vision cameras, are devices that use image
                            ...
                            ● Object Detection and Recognition: Vision sensors enable robots to identify and categorize
                            ...
                            ● Obstacle Avoidance: Vision sensors play a critical role in obstacle detection and avoidance.
                            ...
                            environments.
                            ● Object Sorting and Packaging: Vision sensors are employed in sorting systems to identify
                            ...
                            ● Robot Guidance and Positioning: Vision sensors play a crucial role in robotic systems by
                            ...
                            healthcare.
                            ● Gesture and Human-Machine Interaction: Vision sensors can enable gesture recognition and
                            ...
                            ● Autonomous Vehicles: In the context of autonomous vehicles, vision sensors such as cameras,
                            ...
                            ● Manipulation and Grasping: Cameras and depth sensors aid robots in accurately assessing
                            ...
                            ● Augmented Reality and Virtual Reality: Vision sensors are also used in augmented reality
                            ...
                            to create immersive virtual environments in VR.
                            Tactile Sensors:
                            Tactile sensors, also known as touch sensors, are devices that detect and measure physical
                            ...
                            These sensors are used to detect physical contact or pressure. Examples include force sensors,
                            pressure sensors, and touch sensors.
                            ● Robotic Grasping and Manipulation: Tactile sensors are used in robotic grippers and hands
                            ...
                            ● Prosthetics and Assistive Devices: Tactile sensors are integrated into prosthetic limbs and
                            ...
                            ● Human-Robot Interaction: Tactile sensors enable safe and intuitive interaction between
                            ...
                            and ensure safety.
                            Motion Sensors:
                            Motion sensors, also known as motion detectors, are devices that detect movement or changes in
                            ...
                            They can detect the presence, absence, or movement of objects within their range. Here are some
                            examples of motion sensor applications:
                            ● Security Systems: Motion sensors are commonly used in security systems, such as burglar
                            ...
                            movements.
                            ● Home Automation: Motion sensors are utilized in home automation systems to enable various
                            ...
                            ● Gaming and Virtual Reality: Motion sensors play a vital role in gaming and virtual reality
                            ...
                            ● Automatic Door Openers: Motion sensors are used in automatic door openers found in public
                            buildings, hospitals, or shopping centers. They detect the presence of individuals approaching
                            the door and trigger the door to open automatically, providing convenience and accessibility.
                            ...
                            ● Resistance Temperature Detectors (RTDs): RTDs are temperature sensors that rely on the
                            ...
                            ● Thermistors: Thermistors are temperature sensors that use the change in electrical resistance
                            ...
                            ● Infrared Sensors: Infrared temperature sensors, also known as non-contact or pyrometers,
                            ...
                            are difficult to access or in motion.
                            Gas Sensors:
                            Gas sensors, also known as gas detectors or gas analyzers, are devices that detect and measure
                            ...
                            are used to detect the presence of specific gases in the environment. Examples include carbon
                            monoxide sensors, oxygen sensors, and hydrogen sensors.
                            ● Electrochemical Gas Sensors: Electrochemical gas sensors use a chemical reaction between
                            ...
                            ● Infrared Gas Sensors: Infrared gas sensors detect gases by measuring the absorption of
                            ...
                            ● Catalytic Gas Sensors: Catalytic gas sensors utilize a heated catalyst to promote a chemical
                            ...
                            Light Sensors:
                            Light sensors, also known as photodetectors or photo sensors, are devices that detect and
                            ...
                            Light sensors enable automatic control, energy efficiency, and accurate measurements in various
                            ...
                            ● Photodiodes: Photodiodes are the most common type of light sensors. They are
                            ...
                            ● Phototransistors: Phototransistors are light sensors that combine the functions of a
                            ...
                            proximity sensing.
                            ● Photovoltaic Cells: Photovoltaic cells, also known as solar cells, convert light energy directly
                            ...
                            ● Light-Emitting Diodes (LEDs): While LEDs are primarily used as light sources, they can also
                            ...
                            ● Light-dependent Resistors (LDRs): LDRs, also known as photoresistors, are passive light
                            ...
                            systems.
                            ● Ambient Light Sensors: Ambient light sensors are specialized light sensors that measure the
                            ...
                            energy, and optimize screen visibility.
                            Range Sensors:
                            Range sensors, also known as distance sensors or proximity sensors, are devices that measure the
                            ...
                            distance between the sensor and an object or surface in its environment. Examples include
                            ultrasonic sensors, laser rangefinders, time-of-flight sensors, and infrared sensors etc.
                            ● Ultrasonic Range Sensors: Ultrasonic range sensors emit high-frequency sound waves and
                            ...
                            measurement.
                            ● Laser Range Finders: Laser range finders use laser beams to measure the distance to an
                            ...
                            ● Infrared Range Sensors: Infrared range sensors use infrared light to measure distance. They
                            ...
                            ● Time-of-Flight (ToF) Sensors: Time-of-flight sensors measure distance by measuring the
                            ...
                            ● Capacitive Range Sensors: Capacitive range sensors measure the distance to an object based
                            ...
                            Overall, sensors are critical components in robotics that enable the robot to interact with its
                            environment and perform tasks autonomously.

                            Importance of Sensors in Robotics
                            Sensors play a critical role in robotics by providing robots with the ability to perceive and
                            interact with their environment. Here are some examples of how sensors are used in robotics and
                            why they are important:
                            ● Obstacle avoidance in autonomous vehicles - Autonomous vehicles rely on a variety of
                            ...
                            ● Object detection in industrial automation - In industrial automation, sensors are used to
                            ...
                            ● Feedback control in medical robotics - Sensors are used in medical robotics to provide
                            ...
                            ● Navigation in drones - Drones rely on sensors such as GPS and altimeters to maintain
                            ...
                            environment, making them safer and more efficient.
                        </p>
